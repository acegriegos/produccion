...
<head>
  ...
  {$STY}
  <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-proveedor.css?v=10.4.1.0">
    ...
    <body >
      ...
      {$SCR}
      <!-- <script src="../assets/libs/charts/dist/Chart.bundle.min.js?v=10.4.1.0"></scrsipt> -->
      <script src="../assets/js/modulos/proveedor.js?v=10.4.1.0"></script>
    </body>
    </html>