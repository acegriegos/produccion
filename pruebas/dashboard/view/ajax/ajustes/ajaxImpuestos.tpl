<div class="card pequeño">
    <h3 class="card-block center-align">Impuestos del Sistema</h3>
    <div class="card-block pequeño">
        
        <a href="#modal-impuestos" class="btn btn-floating btn2 der z-depth-2 mdi mdi-plus mdi-24px tooltipped modal-trigger" id="ingimp" data-position="left" data-tooltip="Ingresar Impuesto"></a>
...
<div id="modal-impuestos" class="modal modal-fixed-footer" style="width:70%;">
    <div class="modal-header head2 padding1">
        <h5 class="modal-title center-align">Agregar Impuesto</h5>
    </div>
    <div class="modal-content" id="fimpuestos">
        <div class="row">
    ...
    <div class="modal-footer">
        <a class="modal-action waves-effect waves-light waves-red btn-flat z-depth-3" style="margin-right: 2%">Guardar</a>
