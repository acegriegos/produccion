	...
	<?php switch ($transaccion[0][17]) {
		...
		default:
			...
			<?php 
                ...
                $exostr = '<input type="checkbox" id="se'.$index.'" checked class="cexo"><label title="Exonerar Línea" for="se'.$index.'" style="display: initial;" class="hide cexol"></label>';

			 ?>

		<div class="col s1 hide"><input type="checkbox" id="check<?php echo $index; ?>" checked><label for="check<?php echo $index; ?>"></label></div> <div style="padding: 0 !important;" class="col s2" id="codprod<?php echo $index; ?>"><?php echo  $exostr.$obj[4]; ?></div> <div style="padding: 0 !important;" class="col s3 center-align" id="desc<?php echo $index; ?>"><?php echo $obj[5]; ?></div> <div style="padding: 0 !important;" class="col s2 center-align divisa hide" id="prec<?php echo $index; ?>"><?php echo number_format($obj[27],2); ?></div> <div style="padding: 0 !important;" class="col s2 center-align divisa" id="fake<?php echo $index; ?>"><?php echo number_format($obj[27],2); ?></div>  <div style="padding: 0 !important;" class="col s1 center-align" id="unitprod<?php echo $index; ?>"><?php echo $obj[19]; ?></div> <div id="divcnt" style="padding: 0 !important;" class="col s1 center-align">  <input type="number" class="browser-default eder" id="cant<?php echo $index; ?>" value="<?php echo number_format($obj[7],2,'.',''); ?>" style="border:0px;width:100%;height:auto !important" /></div> <div style="padding: 0 !important;" class="col s1 center-align totp divisa" id="tota<?php echo $index; ?>"><?php echo number_format($obj[8],2); ?></div> <div class="right">  <a href="#modal-edit" id="edit<?php echo $index; ?>" visible="0" class="mdi mdi-pencil modal-trigger pbtn black-text fedit" style="padding:0px"></a><a href="#" id="del<?php echo $index; ?>" style="color: #D9534F" title="Eliminar Fila" class="mdi mdi-close pbtn black-text delf" style="padding:0px"></a> <span id="mdesc<?php echo $index; ?>"></span> </div>
