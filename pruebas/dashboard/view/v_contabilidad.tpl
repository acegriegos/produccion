...
<head>
    ...
    {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-contabilidad.css?v=10.4.1.0">
  </head>
  <body>
...
{$SCR}
<script src="../assets/js/modulos/contabilidad.js?v=10.4.1.0"></script>
</body>
</html>