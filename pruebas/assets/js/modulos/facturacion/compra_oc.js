...
export function ocdocompra(){
    ...
    $.each($("#fdetallefacturas .ciclos"),function(){
        ...
        costo       = parseFloat($(this).find('.int_oc_costo').html().replace(/,/g,'').trim())+adicional;
        ...
        /*PROVEEDOR PRODUCTOS*/
        console.log(insertar(104,'','null,'+idprod+','+$("#ffacturas .zelda").data('triforce')['vidcliente']+',"",'+(costo-adicional)+','+adicional+',now(),1,0,1,@@usr,'+idcompra));
