...
function rreport(){
    ...
    var align = $(".excel").data('parametros')['align'] == undefined ? '' : $(".excel").data('parametros')['align'];
    ...
    if(original)
        ...
        var otros = Array(Array('orden',orden),Array('conteo',conteo),Array('suma',suma),Array('align',align));
    var atributos = '';
    var vmodulo = {};
    vmodulo['modulo'] = $(".principal .filtros").attr('modulo');
    var search = new Array;
...
$(document).on('keydown','.fastProduct',function(e){
    ...
    if (/[a-zA-Z0-9-_. ]/i.test(charStr) || charCode == 8) {
        ...
        $(this).autocomplete({
            limit: 20,
            data: getNAutocomplete('id,trim(nombre) as nom,null',11,'id > 0 and id in(select idproducto from detalleinventarios where idinventario = '+inv+') and (nombre like "%'+$(this).val()+'%" or codigo like "%'+$(this).val()+'%" ) limit 20'),
