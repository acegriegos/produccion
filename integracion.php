...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/fonts/materialdesignicons/materialdesignicons.css?v=10.4.0.0">
...
<body style="margin-left: 3%; margin-right: 3%">
    ...
    <script src="assets/js/main.js?v=10.4.0.0"></script>
