            ...
            if(!openssl_pkcs12_read(file_get_contents($target_path), $certs, $pin)){
                ...
                if (isset($json_response->access_token)) {
                    ...
                    if($accept){
                        ...
                        $rs = $db->ejecutar("insert into sucursales values(null,'".$salida['CN']."',1,'','".$salida['cedula']."','','',".$salida['tipo'].",'assets/p12/".$name."','".$pin."',NULL,1,0,1,'".$userComprobante."','".$passComprobante."',1,'',NULL,NULL,NULL,120,0,'')");
