...
<html lang="es">
  <head>
    ...
    {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-verfacturas.css?v=10.0.0.75">
  </head>
  <body>
    ...
    <script src="../assets/js/modulos/verfacturas.js?v=10.0.0.75"></script>
  </body>
</html>