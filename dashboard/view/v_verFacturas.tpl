...
<html lang="es">
  <head>
    ...
    {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-verfacturas.css?v=10.2.0.77">
  </head>
  <body>
    ...
    <script src="../assets/js/modulos/verfacturas.js?v=10.2.0.77"></script>
  </body>
</html>