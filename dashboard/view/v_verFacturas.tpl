...
<html lang="es">
  <head>
    ...
    {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/dropzone.css?v=10.0.0.50">
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-verfacturas.css?v=10.0.0.50">
  </head>
  <body>
    ...
    <script src="../assets/js/dropzone.js?v=10.0.0.50"></script>
    <script src="../assets/js/modulos/verfacturas.js?v=10.0.0.50"></script>
  </body>
</html>