...
<html lang="es">
  <head>
    ...
    {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-verfacturas.css?v=10.0.0.6">
  </head>
  <body>
    ...
    {$SCR}
    <script src="../assets/js/modulos/verfacturas.js?v=10.0.0.6"></script>
  </body>
</html>