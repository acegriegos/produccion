...
<html lang="es">
  <head>
   ...
   {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-presupuesto.css?v=10.2.0.75">
  ...
  <br>
    ...
    {$SRC}
    <script src="../assets/js/modulos/presupuesto.js?v=10.2.0.75"></script>
  </body>
</html>