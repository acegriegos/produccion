...
<html lang="es">
  <head>
   ...
   {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-presupuesto.css?v=10.0.1.15">
  ...
  <br>
    ...
    {$SRC}
    <script src="../assets/js/modulos/presupuesto.js?v=10.0.1.15"></script>
  </body>
</html>