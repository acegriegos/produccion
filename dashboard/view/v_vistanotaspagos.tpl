...
<html lang="es">
  <head>
   ...
   {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-vistanotaspagos.css?v=10.1.0.90">
  </head>
  <body>
  <br>
    {$NAV}
    ...
    {$SCR}
    <script src="../assets/js/modulos/vistanotaspagos.js?v=10.1.0.90"></script>
  </body>
</html>