...
<head>
  ...
  {$STY}
  <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-newReport.css?v=10.2.0.34.1">
</head>
<body class="black">
  ...
  <script src="../assets/js/modulos/reportes/inventarios.js?v=10.2.0.36.3"></script>
</body>
</html>