...
<!--     <div class="center">
  ...
  <script src="../assets/js/modulos/reportes/xlsx.core.min.js?v=10.2.0.55"></script>
  <script src="../assets/js/modulos/reportes/FileSaver.min.js?v=10.2.0.55"></script>
  <script src="../assets/js/modulos/reportes/tableexport.min.js?v=10.2.0.55"></script>
  {literal}
