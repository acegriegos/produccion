...
<head>
  ...
  {$STY}
  <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-newReport.css?v=10.0.0.80">
</head>
<body>
  <div class="container principal">
      <div class="filtros row" entrefechas entrenumeros porcliente porusuario portipo="varios" tbltipos="168,26" tipos="Tipo,Tipo Pago" elem="0,1" sp="167" modulo="reporteFactura" types="1,1" bisprov="1"></div>
      <!-- HEADER -->
  ...
  {$SCR}
  <script src="../assets/js/modulos/reportes/reportes.js?v=10.0.0.80"></script>
  <script src="../assets/js/modulos/reportes/ventas.js?v=10.0.0.80"></script>
</body>
</html>