...
<head>
  ...
  {$STY}
  <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-newReport.css?v=10.0.0.16">
</head>
<body>
  ...
  {$SCR}
  <script src="../assets/js/modulos/reportes/reportes.js?v=10.0.0.16"></script>
  <script src="../assets/js/modulos/reportes/ventas.js?v=10.0.0.16"></script>
</body>
</html>