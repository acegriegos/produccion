...
<body class="black">
  <div class=" principal contenedor" >
      <div class="filtros row" porcliente  entrefechas portipo="varios" porproducto tbltipos="21,20,22,64" tipos="Por Tipo, Por Familia, Por Marcas, Por Factura" types="1,1,1,2" elem="0,0" sp="307"  bisprov="0"></div>
      <!-- HEADER -->
  ...
  <script src="../assets/js/modulos/reportes/ganancias.js"></script>
</body>
</html>