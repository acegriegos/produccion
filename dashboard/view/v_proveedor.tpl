...
<head>
  ...
  {$STY}
  <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-proveedor.css?v=10.2.0.71">
    ...
    <body >
      ...
      {$SCR}
      <!-- <script src="../assets/libs/charts/dist/Chart.bundle.min.js?v=10.2.0.71"></scrsipt> -->
      <script src="../assets/js/modulos/proveedor.js?v=10.2.0.71"></script>
    </body>
    </html>