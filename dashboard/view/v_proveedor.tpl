...
<head>
  ...
  {$STY}
  <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-proveedor.css?v=10.0.0.17">
    ...
    <body >
      ...
      {$SCR}
      <!-- <script src="../assets/libs/charts/dist/Chart.bundle.min.js?v=10.0.0.17"></scrsipt> -->
      <script src="../assets/js/modulos/proveedor.js?v=10.0.0.17"></script>
    </body>
    </html>