...
<head>
  ...
  {$STY}
  <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-proveedor.css?v=10.0.1.16">
    ...
    <body >
      ...
      {$SCR}
      <!-- <script src="../assets/libs/charts/dist/Chart.bundle.min.js?v=10.0.1.16"></scrsipt> -->
      <script src="../assets/js/modulos/proveedor.js?v=10.0.1.16"></script>
    </body>
    </html>