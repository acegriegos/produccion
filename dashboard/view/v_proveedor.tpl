...
<head>
  ...
  {$STY}
  <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-proveedor.css?v=mesero">
    ...
    <body >
      ...
      {$SCR}
      <!-- <script src="../assets/libs/charts/dist/Chart.bundle.min.js?v=mesero"></scrsipt> -->
      <script src="../assets/js/modulos/proveedor.js?v=mesero"></script>
    </body>
    </html>