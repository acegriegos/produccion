...
<head>
  ...
  {$STY}
  <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-proveedor.css?v=10.1.0.70">
    ...
    <body >
      ...
      {$SCR}
      <!-- <script src="../assets/libs/charts/dist/Chart.bundle.min.js?v=10.1.0.70"></scrsipt> -->
      <script src="../assets/js/modulos/proveedor.js?v=10.1.0.70"></script>
    </body>
    </html>