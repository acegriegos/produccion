...
<head>
  ...
  {$STY}
  <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-proveedor.css?v=10.3.0.22">
    ...
    <body >
      ...
      {$SCR}
      <!-- <script src="../assets/libs/charts/dist/Chart.bundle.min.js?v=10.3.0.22"></scrsipt> -->
      <script src="../assets/js/modulos/proveedor.js?v=10.3.0.22"></script>
    </body>
    </html>