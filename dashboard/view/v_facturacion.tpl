...
<html lang="es">
  ...
  {$STY}
  <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-facturacion.css?v=10.0.0.37">
  <body >
  {$NAV}
  ...
  {$SCR}
  <script src="../assets/js/modulos/facturacion.js?v=10.0.0.37"></script>
</html>
