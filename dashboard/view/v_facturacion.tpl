...
<html lang="es">
  ...
  {$STY}
  <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-facturacion.css?v=10.2.0.32">
  <body >
  {$NAV}
  ...
  <script src="../assets/js/modulos/facturacion.js?v=10.2.0.32"></script>
</html>
