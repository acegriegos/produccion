...
<html lang="es">
  ...
  {$STY}
  <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-facturacion.css?v=10.2.0.68">
  <body >
  {$NAV}
  ...
  {$SCR}
  <script src="../assets/js/modulos/facturacion.js?v=10.2.0.68"></script>
</html>
