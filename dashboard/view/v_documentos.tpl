...
<html lang="es">
  <head>
   ...
   {$STY}
   <link rel="stylesheet" type="text/css" href="../assets/css/dropzone.css?v=10.2.0.15">
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-documentos.css?v=10.2.0.15">
  </head>
  <body>
  <br>
    {$NAV}
    ...
    <script src="../assets/js/dropzone.js?v=10.2.0.15"></script>
    <script src="../assets/js/modulos/documentos.js?v=10.2.0.15"></script>
  </body>
</html>