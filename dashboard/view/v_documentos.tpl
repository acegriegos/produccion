...
<html lang="es">
  <head>
   ...
   <link rel="stylesheet" type="text/css" href="../assets/css/dropzone.css?v=10.2.0.40">
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-documentos.css?v=10.2.0.40">
  </head>
  <body>
  <br>
    {$NAV}
    ...
    <script src="../assets/js/modulos/documentos.js?v=10.2.0.40"></script>
  </body>
</html>