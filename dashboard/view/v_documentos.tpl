...
<html lang="es">
  <head>
   ...
   {$STY}
   <link rel="stylesheet" type="text/css" href="../assets/css/dropzone.css?v=10.0.0.73">
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-documentos.css?v=10.0.0.73">
  </head>
  <body>
  <br>
    {$NAV}
    ...
    <script src="../assets/js/dropzone.js?v=10.0.0.73"></script>
    <script src="../assets/js/modulos/documentos.js?v=10.0.0.73"></script>
  </body>
</html>