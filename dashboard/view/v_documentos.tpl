...
<html lang="es">
  <head>
   ...
   <link rel="stylesheet" type="text/css" href="../assets/css/dropzone.css?v=10.0.0.99">
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-documentos.css?v=10.0.0.99">
  </head>
  <body>
  <br>
    {$NAV}
    ...
    <script src="../assets/js/modulos/documentos.js?v=10.0.0.99"></script>
  </body>
</html>