...
<html lang="es">
  <head>
    ...
    <title></title>
    {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-administracion.css?v=10.1.0.42">
  ...
  <body class="tamLetra pequeño">
    ...
    {$SCR}
    <script src="../assets/js/modulos/administracion.js?v=10.1.0.42"></script>
  </body>
</html>