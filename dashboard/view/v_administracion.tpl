...
<html lang="es">
  <head>
    ...
    <title></title>
    {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-administracion.css?v=10.0.0.73">
  ...
  <body class="tamLetra pequeño">
    ...
    {$SCR}
    <script src="../assets/js/modulos/administracion.js?v=10.0.0.73"></script>
  </body>
</html>