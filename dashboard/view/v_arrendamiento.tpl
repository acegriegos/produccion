...
<html lang="es">
  <head>
   ...
   {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-arrendamiento.css?v=10.2.0.0">
  </head>
  <body>
    {$NAV}
  ...
  <div class="modal modal-fixed-footer" id="modal-abono" style="height: 50%; width: 50%">
    ...
    {$SCR}
    <script src="../assets/js/modulos/arrendamiento.js?v=10.2.0.0"></script>
  </body>
</html>