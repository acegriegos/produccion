...
<html lang="es">
  <head>
    ...
    {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-laboratorio.css?v=10.3.0.21">
  </head>
<body>
  {$NAV}
    ...
    {$SCR}
    <!-- <script src="../assets/js/modulos/laboratorio.js?v=10.3.0.21"></script> -->
  </body>
</html>