...
<html lang="es">
  <head>
    ...
    {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-laboratorio.css?v=10.2.0.83">
  </head>
<body>
  {$NAV}
    ...
    {$SCR}
    <!-- <script src="../assets/js/modulos/laboratorio.js?v=10.2.0.83"></script> -->
  </body>
</html>