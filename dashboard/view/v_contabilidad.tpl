...
<head>
    ...
    {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-contabilidad.css?v=10.0.1.21">
  </head>
  <body>
...
{$SCR}
<script src="../assets/js/modulos/contabilidad.js?v=10.0.1.21"></script>
</body>
</html>