...
<head>
    ...
    {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-contabilidad.css?v=10.0.0.86">
  </head>
  <body>
...
{$SCR}
<script src="../assets/js/modulos/contabilidad.js?v=10.0.0.86"></script>
</body>
</html>