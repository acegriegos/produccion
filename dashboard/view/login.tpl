...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-login.css?v=10.1.0.50">
...
<script src="../assets/js/jquery.js?v=10.1.0.50"></script>
<script src="../assets/js/materialize.min.js?v=10.1.0.50"></script>
<script src="../assets/js/asgard.js?v=10.1.0.50"></script>
<script src="../assets/js/modulos/login.js?v=10.1.0.50"></script>
</body>
</html>
