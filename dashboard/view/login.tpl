...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../assets/css/system.min.css?v=10.4.0.2"> 
  <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-login.css?v=10.4.0.2">
      ...
      <div class="login">
       <form role="form" id="logF" action="index.php" method="POST">
        ...
        <div class="login__check" align="center">
          <img id="img" src="../assets/img/login/2.png?v=10.4.0.2" style="width: 80%">
        </div>
...
<script src="../assets/js/modulos/login.js?v=10.4.0.2"></script>
<!-- https://texttospeech.responsivevoice.org/v1/text:synthesize
<script src="../assets/js/responsivevoice.js?v=10.4.0.2"></script> -->
</body>
</html>
