...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-login.css?v=10.3.0.2">
...
<script src="../assets/js/asgard.js?v=10.3.0.2"></script>
<script src="../assets/js/modulos/login.js?v=10.3.0.2"></script>
<!-- https://texttospeech.responsivevoice.org/v1/text:synthesize
<script src="../assets/js/responsivevoice.js?v=10.3.0.2"></script> -->
</body>
</html>
