...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../assets/css/materialize.min.css?v=10.0.0.69">
  <link rel="stylesheet" type="text/css" href="../assets/fonts/materialdesignicons/materialdesignicons.css?v=10.0.0.69">
  <link rel="stylesheet" type="text/css" href="../assets/css/system.min.css?v=10.0.0.69"> 
  <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-login.css?v=10.0.0.69">
...
<script src="../assets/js/materialize.min.js?v=10.0.0.69"></script>
<script src="../assets/js/asgard.js?v=10.0.0.69"></script>
<script src="../assets/js/modulos/login.js?v=10.0.0.69"></script>
</body>
</html>
