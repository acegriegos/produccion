...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-login.css?v=10.2.0.76">
...
<script src="../assets/js/modulos/login.js?v=10.2.0.76"></script>
<!-- https://texttospeech.responsivevoice.org/v1/text:synthesize
<script src="../assets/js/responsivevoice.js?v=10.2.0.76"></script> -->
</body>
</html>
