...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-login.css?v=10.2.0.18">
...
<script src="../assets/js/jquery.js?v=10.2.0.18"></script>
<script src="../assets/js/materialize.min.js?v=10.2.0.18"></script>
<script src="../assets/js/asgard.js?v=10.2.0.18"></script>
<script src="../assets/js/modulos/login.js?v=10.2.0.18"></script>
</body>
</html>
