...
<html lang="es">
  <head>
    ...
    {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-clientes.css?v=10.1.0.90">
  </head>
  <!-- #0B3861 -->
  <body>
    {$NAV}
...
{$SCR}
<script src="../assets/js/modulos/proveedores.js?v=10.1.0.90"></script>
</body>
</html>