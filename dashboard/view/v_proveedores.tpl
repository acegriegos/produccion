...
<html lang="es">
  <head>
    ...
    {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-clientes.css?v=10.2.0.42">
  </head>
  <!-- #0B3861 -->
  <body>
    {$NAV}
...
{$SCR}
<script src="../assets/js/modulos/proveedores.js?v=10.2.0.42"></script>
</body>
</html>