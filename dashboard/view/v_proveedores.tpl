    ...
    <div class="bdy">
        <div class="card">
            ...
            <div class="card-header center blue-grey white-text">
                <p class="flow-text">Proveedores</p>
            </div>
            <div class="card-content">
                <div class="row">
                    ...
                    <div class="col s2 m4">
                        <a id="ingClie" class="der btn-floating tooltipped modal-trigger" data-position="left" data-tooltip="Ingresar Proveedor" href="#modal-clientes"><i class="large material-icons">add</i></a>
                    </div>
                    ...
                    <table class="table centered striped bordered responsive-table" id="data-table-clientes">
                        ...
                        <tbody id="listaclientes">
                            ...
                            <tr id="f{$PROV[LE][0]}">
                                ...
                                <td>{$PROV[LE][6]}</td>
                                <td>
                                    <a href="#" style="color: #686868"><i class="load material-icons pbtn" id="m{$PROV[LE][0]}" modulo="cliente">edit</i></a>
                                    <a href="#" style="color: #686868"><i class="delete material-icons pbtn" modulo="cliente" id="d{$PROV[LE][0]}">delete</i></a>
                                </td>
                            </tr>
                            {/section}
                        </tbody>
                            ...
                            <div class="row">
                                ...
                                <div class="row cre" style="display: none;"> 
                                    ...
                                    <div class="input-field col s12 m6 l6">
                                        ...
                                        <label for="vcredito">Crédito del Proveedor</label>
