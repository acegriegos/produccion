...
<div class="bdy">
<div class="card">
<div class="card-header center blue-grey white-text"><p class="flow-text">Proveedores</p></div>
<div class="card-content">

<div class="row">

<div class="input-field col m8 col l8">
    <a href="#" class="prefix dropdown-button tooltipped" data-activates='fprov' data-position="button" data-tooltip="Cambiar Filtro"><i class="small material-icons">search</i></a>
    <ul id="fprov" class="dropdown-content" filter="1" style="width: 140px">
        ...
        <li><a class="dropdown-item fprov" filtro="f3">Web</a></li>
    </ul>
    <input type="text" id="searchprod" maxlength="100" class="searchclientes validate">
    <label for="searchprod" id="phs">Buscar Cliente Cédula Jurídica o Razón Social</label>
...
<div class="modal modal-fixed-footer" id="modal-proveedores" style="height: 80%; width: 75%">
