...
<body>
    {$NAV}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-proveedores.css?v=10.0.0.67">
...
{$SCR}
<script src="../assets/js/modulos/proveedores.js?v=10.0.0.67"></script>
<script src="../assets/js/jquery.mask.min.js?v=10.0.0.67"></script>
