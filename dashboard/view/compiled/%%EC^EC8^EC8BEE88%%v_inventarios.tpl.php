<?php /* Smarty version 2.6.17, created on 2016-08-22 15:12:53
  ...
  <br>
    ...
    <nav class="navbar navbar-dark bg-primary" style="border-radius: 0px 0px 5px 5px;">
        ...
        <ul class="nav navbar-nav">
            <li class="nav-item">
                <a class="nav-link menu5 active" id="m1" href="#" title="Devoluciones">Devoluciones</a>
            </li>
            ...
            <li class="nav-item menu5" id="m4">
                <a class="nav-link" href="#" title="Contable">Contable</a>
            </li>
        </ul>
    </nav>
    <br>
