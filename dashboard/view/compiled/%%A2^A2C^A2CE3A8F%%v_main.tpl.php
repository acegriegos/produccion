<?php /* Smarty version 2.6.17, created on 2017-12-16 03:06:21
    ...
    <div class="bdy">
        <div class="row" style="border-bottom: 1px solid #e2e2e2">
            ...
            <div class="input-field col s12 m6 l3">
                <select class="ssuc" id="mchange" sel="<?php echo $_SESSION['IMPRESA']; ?>
"></select>
                <label>Seleccione una Sucursal</label>
            </div>
        <?php if ($this->_tpl_vars['USRCIERRE'] == 1): ?>
        <div id="fcajainicialusuarios">
            <div class="input-field col s12 m6 l3" style="border: 3px">
                <i class="prefix"><?php echo $this->_tpl_vars['MONEDA']; ?>
</i>
