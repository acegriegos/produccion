<?php /* Smarty version 2.6.17, created on 2016-12-01 23:20:12
...
<input type="search" id="searchsrv" class="form-control" placeholder="Buscar Código">
<div class="btn-group input-group-addon" role="group" id="fserv" filter="1">
  <i id="btnGroupDrop1" class="dropdown-toggle fa fa-navicon but" data-toggle="dropdown">
  </i>
  <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
      <a class="dropdown-item filtersrv" href="#" filtro="f1">Código</a>
      <a class="dropdown-item filtersrv" href="#" filtro="f2">Nombre</a>
  </div>
</div>
</div>           
</div>
...
<div class="input-group">
<div class="input-group-addon"><b>Codigo</b></div>
<input type="text" class="form-control" id="vcodigo" placeholder="Código de Servicio">
</div><br>
<div class="input-group">
...
<input type="checkbox">
<span class="c-indicator" value="0" id="isPeriodo"></span><b>Por período</b><small type="checkbox" style="color: #A3A3A3" title="Seleccione esta opción si el servicio que desea agregar se va a repetir periódicamente">&nbsp;&nbsp;?</small>
</label>
<!-- <label>
