<?php /* Smarty version 2.6.17, created on 2016-08-12 13:30:44
...
$this->_sections['LE']['loop'] = is_array($_loop=$this->_tpl_vars['TCUE']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
                            <option value="<?php echo $this->_tpl_vars['TCUE'][$this->_sections['LE']['index']][0]; ?>
"><?php echo $this->_tpl_vars['TCUE'][$this->_sections['LE']['index']][1]; ?>
</option>
                        <?php endfor; endif; ?>
                    </select>
...
?>
                            <div class="col-md-6 col-lg-6">
                                <?php echo $this->_tpl_vars['CUE'][$this->_sections['LE']['index']][0]; ?>
