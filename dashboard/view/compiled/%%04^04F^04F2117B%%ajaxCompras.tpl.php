<?php /* Smarty version 2.6.17, created on 2016-08-04 23:27:22
         compiled from ajax/ajaxCompras.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'ajax/ajaxCompras.tpl', 47, false),)), $this); ?>
<div class="row">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-6">
          <div class="input-group">
              ...
              <input type="text" class="form-control" id="idprv" placeholder="Cédula del Cliente">
        ...
        <div class="col-md-6 col-lg-6">
            <div class="input-group">
                ...
                <input type="text" class="form-control" id="nprv" placeholder="Nombre del Cliente">
            </div>
            <br>
        </div>
    ...
    <div class="row">
      ...
      <table class="table table-striped table-hover" style="border: 1px solid #e2e2e2;">
        <tbody>
          ...
          <tr>
            <td>TOTAL MARGEN:</td>
            <td align="right"><span><b>¢</b></span> <span id="tmargen">0.00</span><input type="hidden" id="vtmargen" value="0"> </td>
          </tr>
        </tbody>
      </table>
