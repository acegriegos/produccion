<?php /* Smarty version 2.6.17, created on 2017-05-31 18:22:25
         compiled from ajax/cuentas/ajaxmantCxP.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'math', 'ajax/cuentas/ajaxmantCxP.tpl', 75, false),)), $this); ?>
...
?>
                         <tr class="button-collapse detalle" data-activates="acciones" id="f<?php echo $this->_tpl_vars['PRO'][$this->_sections['LE']['index']][12]; ?>
"  tipo ='2' tp="<?php if ($this->_tpl_vars['PRO'][$this->_sections['LE']['index']][7] < 0): ?>1<?php else: ?>0<?php endif; ?>">
