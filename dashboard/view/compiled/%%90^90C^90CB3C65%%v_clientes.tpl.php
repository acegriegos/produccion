...
<html lang="es">
 ...
 <!-- Page Content -->
    ...
    <div class="bdy">
      <h2 align="center">Mantenimiento Clientes</h2>
      <hr>
      <div class="row">
          ...
          <div class="col-md-6 col-lg-6">
          <button type="button" class="btn btn-primary der" data-toggle="modal" href="#modal-clientes" id="Iadd">Agregar</button>
          </div><br><br><br>
        </div> 
         <div class="row">
      <div class="col-md-12 col-lg-12">
        <div class="table-responsive">
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover dt-responsive nowrap" id="data-table-clientes" cellspacing="0" width="100%" >
                  <thead>
                      <tr>
                          <th>Nombre</th>
                          <th>Cédula</th>
...
?>
                        <tr>
                            ...
                            <td><i class="fa fa-pencil-square-o btn"></i><i class="fa fa-times btn"></i></td>
                        </tr>
                        <?php endfor; endif; ?>
                    </tbody>
              </table>
      ...
      <div class="modal-dialog" style="width: 70%">
        <div class="modal-content">
           ...
           <div class="row">
            <div class="col-md-12 col-lg-12">
              <div class="input-group">
                <div class="input-group-addon"><b>Datos Personales</b></div>
              </div>
            </div>
            </div>
             <br>
            ...
            <div class="col-md-12 col-lg-12">
              <div class="input-group">
                <div class="input-group-addon"><b>Teléfonos</b></div>
              </div>
            </div>
            </div>
            <br>
            <div tabla="detalletelefono" class="enrutador">
            <div class="row">
            <div class="col-md-6 col-lg-6">
              <div class="input-group">
                <div class="input-group-addon"><b> Casa</b></div>
                <input type="text" class="form-control" id="vcasa" placeholder="Teléfono de Casa">
              </div>
            </div>
              <div class="col-md-6 col-lg-6">
              <div class="input-group">
                <div class="input-group-addon"><b> Trabajo </b></div>
                <input type="text" class="form-control" id="vtrabajo" placeholder="Teléfono de Trabajo">
              </div>
            </div>
            </div>
             <br>
            ...
            <div class="col-md-6 col-lg-6">
              <div class="input-group">
                <div class="input-group-addon"><b>Móvil</b></div>
                <input type="text" class="form-control" id="vmovil" placeholder="Teléfono Móvil">
              </div>
            </div>
           </div>
           </div>
          ...
          <div class="row">
            <div class="col-md-12 col-lg-12">
              <div class="input-group">
                <div class="input-group-addon"><b>Direcciones</b></div>
              </div>
            </div>
            </div>
             <br>
