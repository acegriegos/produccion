<?php /* Smarty version 2.6.17, created on 2017-06-06 23:18:28
...
">
                                ...
                                <td>
                                     <?php if ($this->_tpl_vars['PROV'][$this->_sections['LE']['index']][13] != 1): ?>
                                    <a href="modal-contactos" style="font-size: 2em; color: #607d8b" title="Contactos"><i class="contact material-icons pbtn" id="c<?php echo $this->_tpl_vars['PROV'][$this->_sections['LE']['index']][0]; ?>
">contact_phone</i></a>
                                    <?php endif; ?>

                                    <a href="#modal-clientes" class="load material-icons pbtn per1002" id="m<?php echo $this->_tpl_vars['CLIE'][$this->_sections['LE']['index']][0]; ?>
" modulo="cliente" style="font-size: 2em; color: #607d8b">edit</a>
                                    
                                    <a href="#" class="delete material-icons pbtn per1003" modulo="cliente" id="d<?php echo $this->_tpl_vars['CLIE'][$this->_sections['LE']['index']][0]; ?>
