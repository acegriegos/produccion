<?php /* Smarty version 2.6.17, created on 2016-12-02 21:08:02
         compiled from ajax/ajustes/ajaxCuentasDefecto.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'math', 'ajax/ajustes/ajaxCuentasDefecto.tpl', 44, false),)), $this); ?>
<div class="card">
...
$this->_sections['LE']['last']       = ($this->_sections['LE']['iteration'] == $this->_sections['LE']['total']);
?>
            <li class="list-group-item cuecon" style="<?php if ($this->_tpl_vars['VCUE'][$this->_sections['LE']['index']][4] != 1): ?>display: none;<?php endif; ?>" deep="<?php echo $this->_tpl_vars['VCUE'][$this->_sections['LE']['index']][3]; ?>
...
" title="Editar Nombre" style="border: 0px; width:100%;border-left:1px solid #e2e2e2;<?php if ($this->_tpl_vars['VCUE'][$this->_sections['LE']['index']][4] != 1): ?> margin-left: <?php echo smarty_function_math(array('equation' => 'x * y','x' => 2,'y' => $this->_tpl_vars['VCUE'][$this->_sections['LE']['index']][4]), $this);?>
...
?>
        <div class="input-group" modulo="scontabilidad">
        <div class="input-group-addon"><b><?php echo $this->_tpl_vars['DCUE'][$this->_sections['LE']['index']][3]; ?>
 <?php echo $this->_tpl_vars['DCUE'][$this->_sections['LE']['index']][5]; ?>
 </b></div>
        <select class="form-control dsc">
            <option selected> <?php echo $this->_tpl_vars['DCUE'][$this->_sections['LE']['index']][2]; ?>
 </option>
        </select>
        </div>
