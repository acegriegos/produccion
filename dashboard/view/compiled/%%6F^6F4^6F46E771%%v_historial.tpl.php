<?php /* Smarty version 2.6.17, created on 2017-12-16 03:04:47
         compiled from v_historial.tpl */ ?>
<!DOCTYPE html>
<html lang="es">
<head>
<meta charset="utf-8">
...
$this->_sections['LE']['loop'] = is_array($_loop=$this->_tpl_vars['HIS']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
                        <tr>
                            <td style="padding: 10px; color:black;"><?php echo $this->_tpl_vars['HIS'][$this->_sections['LE']['index']][1]; ?>
</td>
                            <td style="padding: 10px; color:black;"><?php echo $this->_tpl_vars['HIS'][$this->_sections['LE']['index']][2]; ?>
</td>
                            <td style="padding: 10px; color:black;"><?php echo $this->_tpl_vars['HIS'][$this->_sections['LE']['index']][3]; ?>
</td>
                            <!-- <td style="padding: 10px; color:black;"><?php echo $this->_tpl_vars['HIS'][$this->_sections['LE']['index']][4]; ?>
</td> -->
                            <td>
                                <a class="btn-color pbtn historial mdi mdi-folder mdi-24px per4108 modal-trigger" id="h<?php echo $this->_tpl_vars['HIS'][$this->_sections['LE']['index']][0]; ?>
" href="#modal-historialcliente" title="Historial Cliente" style="color:black;"></a>
                                <a class="btn-color pbtn abonar mdi mdi-credit-card mdi-24px per4109 modal-trigger" id="p<?php echo $this->_tpl_vars['HIS'][$this->_sections['LE']['index']][0]; ?>
" title="Realizar abono" href="#modal-abonar" style="color:black;"></a>
                            </td>
                        </tr>
                    <?php endfor; endif; ?>
                    </tbody>
...
?>
                        <tr>
                            <td style="padding: 10px; color:black;"><?php echo $this->_tpl_vars['CLI'][$this->_sections['LE']['index']][1]; ?>
</td>
                            <td style="padding: 10px; color:black;"><?php echo $this->_tpl_vars['CLI'][$this->_sections['LE']['index']][2]; ?>
</td>
                            <td style="padding: 10px; color:black;"><?php echo $this->_tpl_vars['CLI'][$this->_sections['LE']['index']][3]; ?>
</td>
                            <td style="padding: 10px; color:black;"><?php echo $this->_tpl_vars['CLI'][$this->_sections['LE']['index']][4]; ?>
</td>
                            <td style="padding: 10px; color:black;"><?php echo $this->_tpl_vars['CLI'][$this->_sections['LE']['index']][5]; ?>
</td>
                            <td style="padding: 10px; color:black;"><?php echo $this->_tpl_vars['CLI'][$this->_sections['LE']['index']][6]; ?>
</td>
                            <td style="padding: 10px; color:black;"><?php echo $this->_tpl_vars['CLI'][$this->_sections['LE']['index']][1]; ?>
</td>
                        </tr>
