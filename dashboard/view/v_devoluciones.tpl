...
<head>
  ...
  {$STY}
  <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-devoluciones.css?v=10.3.0.20">
</head>
<body>
  {$NAV}
  ...
  {$SCR}
  <script src="../assets/js/modulos/devoluciones.js?v=10.3.0.20"></script>
</body>
</html>