...
<head>
  ...
  {$STY}
  <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-devoluciones.css?v=10.2.0.2">
</head>
<body>
  {$NAV}
  ...
  {$SCR}
  <script src="../assets/js/modulos/devoluciones.js?v=10.2.0.2"></script>
</body>
</html>