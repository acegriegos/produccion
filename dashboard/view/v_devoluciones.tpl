...
<head>
  ...
  {$STY}
  <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-devoluciones.css?v=10.0.0.19">
</head>
<body>
  {$NAV}
  ...
  {$SCR}
  <script src="../assets/js/modulos/devoluciones.js?v=10.0.0.19"></script>
</body>
</html>