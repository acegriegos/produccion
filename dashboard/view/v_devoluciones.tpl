...
<head>
  ...
  {$STY}
  <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-devoluciones.css">
</head>
<body>
  {$NAV}
  <div class="bdy pequeño card z-depth-5">
    <div class="card-header center white-text" style="background-color:#0B3861">
      <p class="flow-text" style="font-size: 1.9em;">Devoluciones</p>
    </div>
      ...
      <div class="col s12 m12 l12">
        ...
        <div class="row marginzero">
          ...
          <div class="col s8 m2   offset-m4 offset-s3"><br>
            <a class="waves-effect waves-light btn" id="srchfact">Buscar</a>
          </div>
        </div>
        <div class="row marginzero">
          <div class="col s12 m8 l6">
        ...
        <div class="row marginzero hide" id="ftr2">
          ...
          <div class="input-field col s12 m6">
              <i class="mdi mdi-24px mdi-calendar-question prefix"></i>
              <input type="date" class="datepicker" id="hasta" value="" style="font-size: 1.5em; color: black; font-weight: bold;">
          </div> 
        </div>
        <div class="row">
          <div class="col s12">
  ...
  {$SCR}
  <script src="../assets/js/modulos/devoluciones.js"></script>
</body>
</html>