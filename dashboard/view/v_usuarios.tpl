           ...
           <div class="container-fluid">
               ...
               <div class="collapse navbar-collapse navbar-ex1-collapse">
                   <ul class="nav navbar-nav">
                       <li class="menu2 active" id="m1"><a href="#">Mantenimiento Usuarios</a></li>
                       <li class="menu2" id="m2"><a href="#">Permisos Usuarios</a></li>
                       <li class="menu2" id="m3"><a href="#">Historial Usuarios</a></li>
                   </ul>
               </div><!-- /.navbar-collapse -->
                ...
                <table class="table table-striped table-bordered dt-responsive nowrap" id="data-table-usuarios" cellspacing="0" width="100%">
                    ...
                    {section name=LE loop=$USRS}
                        <tr>
                          ...
                          <td>{$USRS[LE][4]}</td>
                          <td>
                            <i class="fa fa-pencil-square-o load cargar btn" modulo="usuario" title="Cargar Usuario" id="m{$USRS[LE][0]}"></i>
                            <i class="fa fa-times delete eliminar btn" modulo="usuario" title="Eliminar Usuario" id="d{$USRS[LE][0]}"></i>
                          </td>
                        </tr>
                    {/section}
                    </tbody>
