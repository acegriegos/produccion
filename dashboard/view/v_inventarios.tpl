...
<head>
  ...
  {$STY}
  <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-newReport.css?v=10.2.0.83">
</head>
<body class="black">
  <div class=" principal contenedor">
           <div class="filtros row" sp="127" modulo="reporteFactura" types="1,1" bisprov="0"></div>
    ...
    <div class="row header">
      ...
      <div class="col s6 m4 l4" align="center">
        <h2 align="center" style="margin-top: 0px" id="titrep">Inventario General</h2>
        <font size="3">
          <b>{$MIS[0]}</b><br>
  ...
  {$SCR}
  <script src="../assets/js/modulos/reportes/reportes.js?v=10.2.0.83"></script>
  <script src="../assets/js/modulos/reportes/ventas.js?v=10.2.0.83"></script>
  <script src="../assets/libs/jspdf/jspdf.js?v=10.2.0.83"></script>
</body>
</html>