...
<html lang="es">
  <head>
    ...
    {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-inventarios.css?v=10.0.1.12">
  </head>
  <body class="pequeño">
    {$NAV}
    <div class="bdy pequeño">
      ...
      <div class="card pequeño card-content mdinvent z-depth-3 ">
        <div class="row pequeño">
          <div class="input-field col s12 m6 l6 pequeño hide" >
    ...
    {$SCR}
    <script src="../assets/js/modulos/inventarios.js?v=10.0.1.12"></script>
  </body>
</html>