...
<html lang="es">
  <head>
    ...
    {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-inventarios.css?v=10.0.1.6">
  </head>
  <body class="pequeño">
    {$NAV}
    ...
    {$SCR}
    <script src="../assets/js/modulos/inventarios.js?v=10.0.1.6"></script>
  </body>
</html>