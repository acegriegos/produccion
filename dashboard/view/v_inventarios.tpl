...
<head>
  ...
  {$STY}
  <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-newReport.css?v=10.2.0.68">
</head>
<body class="black">
  ...
  {$SCR}
  <script src="../assets/js/modulos/reportes/reportes.js?v=10.2.0.68"></script>
  <script src="../assets/js/modulos/reportes/ventas.js?v=10.2.0.68"></script>
  <script src="../assets/libs/jspdf/jspdf.js?v=10.2.0.68"></script>
</body>
</html>