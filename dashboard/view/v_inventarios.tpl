...
<body class="black">
  ...
  {$SCR}
  <script src="../assets/js/modulos/reportes/reportes.js?v=10.2.0.61"></script>
  <script src="../assets/js/modulos/reportes/ventas.js?v=10.2.0.61"></script>
  <script src="../assets/libs/jspdf/jspdf.js?v=10.2.0.61"></script>
</body>
</html>