...
<html lang="es">
  <head>
    ...
    {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-financiero.css?v=10.0.0.54">
  </head>
  <body>
    {$NAV}
    ...
    {$SCR}
    <script src="../assets/js/modulos/financiero.js?v=10.0.0.54"></script>
  </body>
</html>