...
<html lang="es">
  <head>
    ...
    {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-financiero.css?v=10.1.0.48">
  </head>
  <body>
    {$NAV}
    ...
    {$SCR}
    <script src="../assets/js/modulos/financiero.js?v=10.1.0.48"></script>
  </body>
</html>