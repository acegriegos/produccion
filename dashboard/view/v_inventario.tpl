...
<html lang="es">
  <head>
    ...
    {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-inventario.css?v=10.2.0.67">
  ...
  <body>
    ...
    {$SCR}
    <script src="../assets/js/modulos/inventario.js?v=10.2.0.67"></script>
  </body>
</html>