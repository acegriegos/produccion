...
<head>
    ...
    {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-produccion.css?v=10.3.0.22">
...
{$SCR}
<script src="../assets/js/modulos/produccion.js?v=10.3.0.22"></script>
</body>
</html>