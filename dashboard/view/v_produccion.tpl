...
<head>
    ...
    {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-produccion.css?v=10.0.0.24">
...
{$SCR}
<script src="../assets/js/modulos/produccion.js?v=10.0.0.24"></script>
</body>
</html>