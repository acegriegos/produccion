...
<head>
    ...
    {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-produccion.css?v=10.1.0.41">
...
{$SCR}
<script src="../assets/js/modulos/produccion.js?v=10.1.0.41"></script>
</body>
</html>