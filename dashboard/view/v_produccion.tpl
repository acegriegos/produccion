...
<head>
    ...
    {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-produccion.css?v=10.2.0.25">
...
{$SCR}
<script src="../assets/js/modulos/produccion.js?v=10.2.0.25"></script>
</body>
</html>