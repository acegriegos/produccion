...
<head>
    ...
    {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-produccion.css?v=10.2.0.17">
...
{$SCR}
<script src="../assets/js/modulos/produccion.js?v=10.2.0.17"></script>
</body>
</html>