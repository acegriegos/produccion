...
<head>
    ...
    {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-produccion.css?v=10.0.0.44">
...
{$SCR}
<script src="../assets/js/modulos/produccion.js?v=10.0.0.44"></script>
</body>
</html>