...
<head>
	...
	{$STY}
	<link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-productos.css?v=10.2.0.67">
</head>
<body>
{$NAV}
...
{$SCR}
<script src="../assets/js/modulos/productos.js?v=10.2.0.67-1"></script>
</body>
</html>