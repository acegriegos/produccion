<ul id="slide" class="side-nav blue-text text-darken-2 " style="max-width: 400px !important; font-size: 2.4em !important">
  ...
  <div class="options" style="padding-bottom: 20%">
    <li class="per1"><a href="dashboard" class="black-text"><i class="mdi mdi-home-variant mdi-24px right" aria-hidden="true" style="color: #000000 ">dashboard</i><span style="font-size: 1.2em !important" >Inicio</span></a></li>
    ...
    <li class="per3"><a href="proveedor"><i class="mdi mdi-store mdi-24px right" aria-hidden="true" style="color: #000000">store</i><span style="font-size: 1.2em !important">Área de Operaciones</span></a></li>

    <li class="per4"><a href="financiero"><i class="mdi mdi-credit-card mdi-24px right" aria-hidden="true" style="color: #000000">credit_card</i><span style="font-size: 1.2em !important">Área Financiera</span></a></li>

    <li class="per5"><a href="inventario"><i class="mdi mdi-basket mdi-24px right" aria-hidden="true" style="color: #000000">shopping_basket</i><span style="font-size: 1.2em !important">Área de Inventarios</span></a></li>

    <li class="per6"><a href="produccion"><i class="mdi mdi-quality-high mdi-24px right" aria-hidden="true" style="color: #000000">high_quality</i><span style="font-size: 1.2em !important">Área de Producción</span></a></li>

    <li class="per7"><a href="administracion"><i class="mdi mdi-settings mdi-24px right" aria-hidden="true" style="color: #000000">settings</i><span style="font-size: 1.2em !important">Área Administrativa</span></a></li>

    <li class="hide"><a href="reportes"><i class="mdi-google-analythics mdi-24px right" aria-hidden="true" style="color: #000000;">trending_up</i><span style="font-size: 1.2em !important">Reportes</span></a></li>
