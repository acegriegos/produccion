...
<ul id="slide" class="side-nav blue-text text-darken-2 " style="max-width: 400px !important; font-size: 2.4em !important">
  ...
  <div class="options" style="padding-bottom: 20%">
    ...
    <li><a href="logout"><i class="mdi mdi-airplane-takeoff mdi-24px right gtext" aria-hidden="true";"></i><span style="font-size: 1.2em !important">Cerrar Sesión</span></a></li>
  </div>
</ul>
