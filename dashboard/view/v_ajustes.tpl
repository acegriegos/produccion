...
<html lang="es">
  <head>
    ...
    {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/dropzone.css?v=10.0.1.2">
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-ajustes.css?v=10.0.1.2">
  </head>
<body>
  {$NAV}
  ...
  <script src="../assets/js/modulos/ajustes.js?v=10.0.1.2"></script>
</body>
</html>