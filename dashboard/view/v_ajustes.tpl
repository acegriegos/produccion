...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-ajustes.css?v=10.0.0.91">
  </head>
<body>
  {$NAV}
  ...
  {$SCR}
  <script src="../assets/js/dropzone.js?v=10.0.0.91"></script>
  <script src="../assets/js/modulos/ajustes.js?v=10.0.0.91"></script>
</body>
</html>