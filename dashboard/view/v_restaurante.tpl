...
<html lang="es">
  <head>
   ...
   {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-restaurante.css?v=10.2.0.67">
  </head>
  <body>
    {$NAV}
    ...
    {$SCR}
    <script src="../assets/js/modulos/restaurante.js?v=10.2.0.67"></script>
  </body>
</html>