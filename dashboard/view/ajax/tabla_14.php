...
<tr>
    ...
    <td style="width: 18%">
        ...
        <a class="btn-color pbtn descuentos per4103 modal-trigger mdi mdi-percent mdi-24px" id="desc<?php echo $obj[0]; ?>" href="#modal-descuentos" title="Mostrar Descuentos del Producto" style="color: #686868 !important;"></a>
