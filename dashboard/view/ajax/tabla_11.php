...
?>
 ...
 <tr>
    ...
    <td>
    <span class="descuentos btn" id="desc<?php echo $obj[0] ?>" data-toggle="modal" href="#modal-descuentos" title="Agregar Descuentos a Producto"><b>%</b></span>    
    ...
    <i class="fa fa-times btn delprod" id="d<?php echo $obj[0] ?>" style="color: #D9534F" title="Eliminar Producto"></i>
    </td>
</tr>
