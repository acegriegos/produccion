<?php
	$tipopagos = $log->kamehameha('id,nombre,extra,regex',26,'id > 0 and id <> 99 and bancos in(0,1,2,4)');
...
<tr>
	...
	<td style="padding: 10px;" class="rtp" rtp="<?php echo $obj[13]?>" rid="<?php echo $obj[0]?>" tp="<?php echo $obj[15]?>"><?php echo $obj[14] == 1 ? $strpagos : $obj[5]?></td>
