		...
		<div class="card white darken-1 z-depth-3">
			<div class="card-content">
				<div class="row marginzero">
					<div class="col s12 m12 l12">
						<table class="table responsive-table centered striped bordered highlight z-depth-5 pequeño" id="data-table-bboletas" cellspacing="0" width="100%" >
							<thead>
								<tr>
									<th class="white-text blue" style="border: 0; border-radius: 0px !important;">N&deg; Boleta</th>
