						...
						<li class="list-group-item">
							<div class="row">
								...
								<div class="col-xs-3 col-sm-3">
									<input type="number" id="cantt1" class="form-control form-control-sm editCantDevo" value="" min="{1}" required="required" title="" readonly>
								</div>
							</div>
						</li>
						<li class="list-group-item">						
							<div class="row">
								...
								<div class="col-xs-3 col-sm-3">
									<input type="number" id="cantt2" class="form-control form-control-sm editCantDevo" value="" min="{1}" required="required" title="" readonly>
								</div>
							</div>
						</li>
					</ul>
