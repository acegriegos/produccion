...
<div class="row">
    <div class="col s8 m8 l8"><br>
        <div class="input-field col s8 m8">
            ...
            <label for="vfiltro">Buscar por nombre</label>
    ...
    <div class="col s4 m4 l4 center" id="dinsu">
        <div class="insu col s12 m6 l6"><a id="addinsumo" class="tinsu button-collapse" href="#modal-insumos">Agregar Insumo</a></div>
        <div class="insu col s12 m6 l6"><a id="addtipoinsumo" class="tinsu" data-activates="nav-tipoinsumo" onclick="">Agregar Tipo Insumo</a></div>
        <!-- <a href="#" data-activates="slide-out" class="button-collapse"><i class="material-icons">menu</i></a> -->
        <!-- <a class="btn-large waves-effect waves-light blue" id="addinsumo" href="#modal-insumos">Agregar Insumo</a>
    </div>
    <div class="col s3 m3 l3"><br>
        <a class="btn-large waves-effect waves-light blue" id="addinsumo" href="#modal-insumos">Agregar Tipo Insumo</a> -->
    </div>
