...
<table class="table striped pequeño  bordered highlight centered responsive-table z-depth-3" id="data-table-inventarios" cellspacing="0" width="100%" >
    <thead>
       <tr>
        ...
        <td class="white-text blue sinborde " style="text-align: center"><b>Peso</b></td>
    ...
    <tr id="<?php echo $obj[13]; ?>" metrica="<?php echo $obj[14]; ?>">
        <td style=" padding: 1px;text-align: left;" class=""><?php echo $obj[0] ?></td>
        ...
        <td style=" padding: 1px;text-align: right;"><input type="number" class="eder browser-default peso" style="border: 0px" value="<?php echo number_format($obj[27],2,'.','') ?>"/></td>
        ...
        <td style=" padding: 1px;text-align: right;"> <span class="notasprod" name="<?php echo $obj[2] ?>" tbl="11" row="<?php echo $obj[13]; ?>" style="cursor: pointer;"><?php echo $obj[18] ? substr($obj[18], 0,15) : '---'; ?></span> </td>
...
<script type="text/javascript" src="../assets/js/modulos/254.js?v=10.4.1.0"></script>