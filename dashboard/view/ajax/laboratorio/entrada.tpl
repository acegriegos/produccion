...
<html lang="es">
  <head>
    ...
    {$STY}
    <link rel="stylesheet" type="text/css" href="../assets/css/modulos/style-laboratorio.css?v=10.2.0.12">
  </head>
<body>
  {$NAV}
...
<!--         <div class="card-header center head1 z-depth-1">
    ...
    {$SCR}
    <script src="../assets/js/modulos/laboratorio.js?v=10.2.0.12"></script>
  </body>
</html>