<table class="table striped pequeño bordered highlight centered responsive-table z-depth-3" id="data-table-inventarios" cellspacing="0" width="100%" >
    <thead>
        <tr>
            ...
            <th class="white-text tab1" style="border: 0;  border-radius: 0px !important;">Minimo</th>
            <th class="white-text tab1" style="border: 0;  border-radius: 0px !important;">Maximo</th>
            <th class="white-text tab1" style="border: 0;  border-radius: 0px !important;">Cantidad</th>
            <th class="white-text tab1" style="border: 0;  border-radius: 0px !important;">Compras</th>
            <th class="white-text tab1" style="border: 0;  border-radius: 0px !important;">Ventas</th>
