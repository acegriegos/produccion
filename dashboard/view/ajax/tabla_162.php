...
<tr id="fd<?php echo $index ?>" class="ciclos">
	<td class="center" id="codprod<?php echo $index ?>"><?php echo $obj[3] ?></td>
	<td class="center" id="desc<?php echo $index ?>"><?php echo $obj[4] ?></td>
	<td class="center"><div><span id="cant<?php echo $index ?>"><?php echo $obj[6] ?></span><input type="number" id="vcantidad<?php echo $index ?>" value="<?php echo $obj[6] ?>" min="1" style="display:none;width: 70px"></div></td>
	<td class="center"><div><span id="prec<?php echo $index ?>"><?php echo $obj[5] ?></span><input type="number" id="hprc<?php echo $index ?>" value="<?php echo $obj[5] ?>" min="1" style="display:none;width: 70px"></div></td>
