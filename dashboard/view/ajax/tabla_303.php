            ...
            <div class="card blue z-depth-5">
             ...
             <div class="card-content white-text  " style="padding: 0.1% !important">
              ...
              <div class="col s12 m8">
                ...
                <div class="col s12 m6">
                  <p style="padding-top: 1%"><b>Saldo:</b> <span id="isaldo"> <?php $length=sizeof($transaccion)-1; echo $transaccion[$length][5]; ?></span></p>
                ...
                <div class="row " style="padding: 5%; padding-top: 6%;">
                      <div class="col s12">
                ...
                <div class="col s12 ">
                  <div class="card" style="background-color:#0B3861">
                    <div class="card-content white-text ">
                      <div class="center-align"><span class="card-title  ">Notas</span>
                      </div>
                      <div class="row">
