...
<div id="fd<?php echo $index; ?>" data-triforce='{"vaccion":0,"vid" : 0,"vidfactura" : "?","videntrada" : <?php echo $obj[3]; ?>,"vcantidad" : "<?php echo $obj[7]; ?>","vprecio" : "<?php echo $obj[6]; ?>","vdesc" : "<?php echo $obj[15]; ?>","vtotal" : "<?php echo $obj[8]; ?>","vidinventario" : <?php echo $obj[13]; ?>,"timv":"<?php echo $obj[25]; ?>","vidodt" : 0,"vimv" : "<?php echo $obj[9]; ?>","vcomodin" : "<?php echo $obj[10]; ?>","vidunidad" : <?php echo $obj[18]; ?>,"vidimpuestos":"<?php echo $obj[11]; ?>","videxoneracion": "","viddescuentos":"<?php echo $obj[12]; ?>","strimp" : "<?php echo $obj[14]; ?>","exoneracion":<?php echo $obj[20]; ?>,"vcomision":"0","max": "<?php echo $obj[21]; ?>","iddesc":<?php echo $obj[22]; ?>,"vdescuento" : "<?php echo $obj[23]; ?>","iva":0,"isinventariado" : <?php echo $obj[24]; ?>}' xtr="<?php echo $obj[0]; ?>" idprod="<?php echo $obj[3]; ?>}" class="ciclos row col s12"> <div style="padding: 0 !important;" class="col s2 center-align" id="codprod<?php echo $index; ?>"><?php echo $obj[4]; ?></div> <div style="padding: 0 !important;" class="col s3 center-align" id="desc<?php echo $index; ?>"><?php echo $obj[5]; ?></div> <div style="padding: 0 !important;" class="col s2 center-align divisa" id="prec<?php echo $index; ?>"><?php echo number_format($obj[8],2); ?></div> <div style="padding: 0 !important;" class="col s1 center-align" id="unitprod<?php echo $index; ?>"><?php echo $obj[19]; ?></div> <div id="divcnt" style="padding: 0 !important;" class="col s1 center-align"><span id="cant<?php echo $index; ?>"><?php echo $obj[7]; ?></span></div> <div style="padding: 0 !important;" class="col s1 center-align totp" id="tota<?php echo $index; ?>"><?php echo number_format($obj[8],2); ?></div> <div class="right"> <a href="#modal-edit" id="edit<?php echo $index; ?>" visible="0" class="mdi mdi-pencil modal-trigger pbtn black-text fedit" style="padding:0px"></a><a href="#" id="del<?php echo $index; ?>" style="color: #D9534F" title="Eliminar Fila" class="mdi mdi-close pbtn black-text delf" style="padding:0px"></a> <span id="mdesc<?php echo $index; ?>"></span></div> </div>
<?php }
