...
<td style="padding: 0"><input type="checkbox" class="delf" name="eliminarf" id="d<?php echo $index ?>"/><label for="d<?php echo $index ?>"></label></td>
<td  class="center" id="codprod<?php echo $index ?>"><?php echo $obj[4] ?></td>
<td class="center" id="desc<?php echo $index ?>"><?php echo $obj[5] ?></td>
<td class="center" id="prec<?php echo $index ?>"><?php echo $obj[6] ?></td>
<td class="center"><div id="divcnt" class="form-group"><span id="cant<?php echo $index ?>"><?php echo $obj[7] ?></span><input type="number" id="vcantidad<?php echo $index ?>" value="<?php echo $obj[7] ?>" min="1" style=" display:none;width: 70px"></div></td>
...
<tr id="fd<?php echo $index ?>" class="ciclos">
	...
	<input type="hidden" id="h_<?php echo $index ?>" idprod="<?php echo $obj[3] ?>" cant="<?php echo $obj[7] ?>" prec="<?php echo $obj[6] ?>" inv="<?php echo $obj[13] ?>"></td>
</tr>
<?php }
}
?>
