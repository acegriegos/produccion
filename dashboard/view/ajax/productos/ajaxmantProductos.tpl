<div class="pequeño" id="mantProd" >
    ...
    <div class="row pequeño">
        <div class="col s12 pequeño">
            <table class="table centered striped bordered highlight z-depth-3 pequeño dt-responsive nowrap" cellspacing="0" width="100%" style="width: 100%" id="data-table-productos">
                <thead>
                    <tr>
...
<div id="modal-productos" class="modal modal-fixed-footer grandemodal" style="top: 0px !important; min-height: 100vh;">
                ...
                <div class="col s12 l4 row" style="margin:0px; padding: 0px">
                    ...
                    {if $smarty.session.BUSS eq 3}
                        <div class="input-field marginzero col s12 " id="cantpro">
                            <input type="text" id="vcantidad" noClear="1" class="validate der eder" value="0" autocomplete="off">
    ...
    <div class="modal-footer" style="z-index: 2000;">
