<?php foreach ($transaccion as $obj) {
    ...
    <tr id="f<?php echo $obj[0] ?>">
        ...
        <td  style=" padding: 10px;color:black" class="der">
          ...
          <!-- <a href="#modal-servicios" class="modal-trigger hide per1004" style="color:black" title="Servicios"><i class="service mdi mdi-account-details pbtn mdi-24px" id="z<?php echo $obj[0]; ?>"></i></a> -->
