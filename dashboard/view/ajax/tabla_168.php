   	...
   	foreach ($transaccion as $obj) {
   		if ($obj[0] != $idfactura) {
			...
			<tr class="detprod hide grey lighten-3" id="xa'.$obj[0].'">
				...
				<td style="text-align: center, border-radius: 0px !important; background-color:#0B3861" class="white-text"><b>Nombre</b></td>
				<td style="text-align: center, border-radius: 0px !important; background-color:#0B3861" class="white-text"><b>Precio</b></td>
		...
		echo '<tr class="detprod hide xb'.$obj[0].' grey lighten-4">
			...
			<td style="text-align: center;border-radius: 0px !important" class="white-text blue lighten-2">'.$obj[26].'</td>
			<td style="text-align: center;border-radius: 0px !important" class="white-text blue lighten-2">'.$obj[27].'</td>
