        ...
        <section id="fsucursales">
            ...
            <div class="row pequeño">
                ...
                <div class="col s12 m12 l4 pequeño">
                    ...
                    <input type="text" id="vpfisico" autocomplete="off">
                </div>
            </div>
            <div class="row pequeño">
                <div class="col s12 m12 l4 pequeño">
                ...
                <div class="col s12 m12 l5 pequeño">
                    <table class="table pequeño responsive-table centered z-depth-3 bordered" id="data-table-bancos">
                        ...
                        <tbody id="listabancos">
                            ...
                            <tr id="e_{$BNK[LE][0]}">
                                <td>
                                    <input type="text" value="{$BNK[LE][1]}" class="fast-edit center-align" style="border: 0px;margin: 0px; padding: 0px;">
                                </td>
                                <td>
                ...
                <tbody id="detallewsdl">
                    <tr id="fl0">
                        <td>
                            ...
                            <input type="text" id="wsn1" class="constante" value="" placeholder="Nombre del Parámetro" maxlength="64">
                        </td>
                        <td>
                            <input type="text" id="wsv1" value="" placeholder="Valor del Parámetro" maxlength="64">
                        </td>
                    </tr>
                </tbody>
            </table>
            <div class="fixed-action-btn">
                <a class="btn-floating btn-large red" modulo="wsdl" detalle="1"><i class="large mdi mdi-plus"></i></a>
            </div>
        </div>
    </div>
</div><!-- /.modal -->
