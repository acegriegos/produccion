	   ...
	   $pagina = 0;
	   	switch ($_REQUEST['accion']) {
	   		case 1:
			   	...
			   	$smarty  = new mySmarty();
			   	$smarty->setModule('dashboard');
			   	$smarty->assign('TPAGO',$kakaroto->kamehameha('id,nombre,bancos,extra,regex,icono',26,'id >= 0 and bancos <> 99 order by principal desc,nombre'));
			   	...
			   	$smarty->assign('AG',$kakaroto->kamehameha('id,nombre',1,'id > 0 and idtipousuario = 4 and idsucursal = 0  order by nombre'));
