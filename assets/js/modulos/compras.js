...
$(document).ready(function(){
    ...
    $("#del").click(function(){
        ...
        $("#cantp").removeClass("has-danger");
        $("#cantp").removeClass("form-control-danger");
        $("#precp").val('0.00');
        $("#cantI").text(0);
        $("#codp").focus();
    });
...
$(document).on("keyup","#codp",function(e){
    ...
    if (code == 13) {
        ...
        var cod = arr('login',4,'vid,vcodigo,vnombre,vprecio,vcantidad',43,'vcodigo = \"'+ kbrota +'\"','',0,'')[0][0];
