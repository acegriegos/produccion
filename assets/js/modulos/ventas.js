...
function searchClient(vvariable,visprv){
    ...
    producto.each(function(i) {
        ...
        var prod = arr('login',4,'',43,idprod+',@@impresa,'+$(".zelda").data('triforce')['vidcliente']+','+getParameterByName('tf'),0,0,0)[0][0];
