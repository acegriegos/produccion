    ...
    if(config[3] == 1){ //ENVIO RAPIDO DE FACTURA
        ...
        switch(param){
            ...
            default:
                ...
                if (config[4] == 1) {
                    w = window.open('facturacion?accion=6&id='+vid+'&tp='+$("#p_v").is(':checked'));
                    try{ 
                        w.print();
                      setTimeout(function(){
