...
(function (factory) {
  ...
  * ============================== */
  ...
  var Tokenfield = function (element, options) {
    ...
    this.$copyHelper = $('<input type="text" id="tokenSpace"/>').css('position', 'absolute').css(hidingPosition, '-10000px').prop('tabindex', -1).prependTo( this.$wrapper )
  ...
  , createToken: function (attrs, triggerChange) {
      ...
      var $token = $('<div class="token" />')
            .append('<span class="token-label" id="s'+consec+'" precio="0" cantidad="0" />')
