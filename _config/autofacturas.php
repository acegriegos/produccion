<?php 
    ...
    $fact_sin_subir = $db->ejecutar('call krattos("id,consecutivo",64,"feestado in(0,7) and id > 1")')->fetch_all();
    ...
    $fact_sin_estado = $db->ejecutar('call krattos("id,consecutivo",64,"feestado in(2) and id > 1")')->fetch_all();
